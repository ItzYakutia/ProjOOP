...
public class LessonController {
    ...
    public void addLesson(String lessonId, String courseId, String topic, LessonType type) {
        ...
        Lesson lesson = new Lesson(lessonId, course, topic, type);
        lessons.add(lesson);
        course.addLesson(lesson);
        System.out.println("Lesson added successfully for course: " + course.getName());
    }
